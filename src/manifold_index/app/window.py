"""
app/window.py — Main window for the v0.3.9 tabbed GUI.
...
class MainWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("Refined 3D Index Calculator — v0.3.9")
...
def launch_gui() -> None:
    ...
    app.setApplicationName("Refined 3D Index Calculator v0.3.9")
